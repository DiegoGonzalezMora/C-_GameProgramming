...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        Texture2D spriteGreenrock;
        Texture2D spriteMagentarock;
        Texture2D spriteWhiterock;
        ...
        protected override void LoadContent()
        {
            ...
            spriteGreenrock = Content.Load<Texture2D>(@"graphics/greenrock");
            spriteMagentarock = Content.Load<Texture2D>(@"graphics/magentarock");
            spriteWhiterock = Content.Load<Texture2D>(@"graphics/whiterock");
        }
        ...
        private Texture2D GetRandomSprite()
        {
            ...
            if (spriteNumber == 0)
            {
                return spriteGreenrock;
            }
            else if (spriteNumber == 1)
            {
                return spriteMagentarock;
            }
            else
            {
                return spriteWhiterock;
            }
