...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            foreach (TeddyBear bear in bears)
            {
                ...
                foreach (Projectile projectile in projectiles)
                {
                    ...
                    if (projectile.Type.ToString() == "FrenchFries") {
                ...
                if (bear.Active && bear.CollisionRectangle.Intersects(burger.CollisionRectangle)) {
                    ...
                    bear.Active = false;
                    explosions.Add(new Explosion(explosionSpriteStrip, burger.CollisionRectangle.X, burger.CollisionRectangle.Y));
                }
            }
            ...
            foreach (Projectile p in projectiles) {
                ...
                if (p.Active && p.Type.ToString() == "TeddyBear" && p.CollisionRectangle.Intersects(burger.CollisionRectangle)) {
                    p.Active = false;
        ...
        private void SpawnBear()
        {
            ...
            while (!CollisionUtils.IsCollisionFree(bear.DrawRectangle, rectangles)) {
