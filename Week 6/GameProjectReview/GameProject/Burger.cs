...
namespace GameProject
{
    ...
    public class Burger
    {
        ...
        public void Update(GameTime gameTime, MouseState mouse)
        {
            ...
            if (health > 0)
            {
                if (canShoot && ButtonState.Pressed == mouse.LeftButton)
                {
                    canShoot = false;
                    Texture2D frenchfriesSprite = Game1.GetProjectileSprite(ProjectileType.FrenchFries);
                    Projectile projectile = new Projectile(ProjectileType.FrenchFries, frenchfriesSprite,
                                                           drawRectangle.X + sprite.Width / 2, drawRectangle.Y - GameConstants.FrenchFriesProjectileOffset,
                ...
                if (mouse.X < GameConstants.WindowWidth - drawRectangle.Width && mouse.X >= 0)
                {
                    drawRectangle.X = mouse.X;
                }

                if (mouse.Y < GameConstants.WindowHeight - drawRectangle.Height && mouse.Y >= 0)
                {
